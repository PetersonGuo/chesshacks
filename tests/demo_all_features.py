...
def demo_architecture():
    ...
    score_opt = c_helpers.alpha_beta_optimized(
        ...
        c_helpers.evaluate_with_pst, tt, 0, killers, history
    )
...
def demo_pvs_and_iid():
    ...
    score = c_helpers.alpha_beta_optimized(
        fen, 5, c_helpers.MIN, c_helpers.MAX, True,
        c_helpers.evaluate_with_pst, tt, 0, killers, history
    )
...
def demo_parallel_search():
    ...
    score1 = c_helpers.alpha_beta_optimized(
        fen, 5, c_helpers.MIN, c_helpers.MAX, True,
        c_helpers.evaluate_with_pst, tt1, 1  # num_threads=1
    )
    ...
    score4 = c_helpers.alpha_beta_optimized(
        fen, 5, c_helpers.MIN, c_helpers.MAX, True,
        c_helpers.evaluate_with_pst, tt4, 4  # num_threads=4
    )
...
def demo_data_structures():
    ...
    score1 = c_helpers.alpha_beta_optimized(
        fen1, 4, c_helpers.MIN, c_helpers.MAX, False,
        c_helpers.evaluate_with_pst, tt, 0, killers, history
    )
    ...
    score2 = c_helpers.alpha_beta_optimized(
        fen2, 4, c_helpers.MIN, c_helpers.MAX, True,
        c_helpers.evaluate_with_pst, tt, 0, killers, history
    )
...
def demo_performance_comparison():
    ...
    features = [
        "TT caching", "5-tier move ordering", "Killer moves",
        "History heuristic", "Null move pruning", "Quiescence search",
        "Iterative deepening", "LMR", "Aspiration windows",
        "PVS", "IID", "Piece-square tables"
    ]
